...
//[patch_1
#region SoftRock40 Extensions
// SoftRock40 Extensions
//
//	Bug Fixes:
//
//  Modifications:
//
//		Feature:		SoftRock40 Extensions
//		Change:	
//
// PowerSDR has been extended for use with SoftRock40 model. Features include:
// 
...
// To use this feature, set "IQ Correction" setting in the tab Setup/Audio/Sound Card.
// 
...
// To use this feature, deselect "Receive Only" in General/Hardware Config.
//
...
// To use this feature, select in Setup/Audio/Sound Card a card that is connected to your radio. Select "Enable VAC" in Setup/Audio/VAC, and select the other sound card to speaker/mic. Select "As Primary Audio Device" too, in order to get the audio there where needed.
// A VOX might be enabled, "LPT Address" should be set to 0 to disable a possible interfering LPT input line used as PTT (pin 10).
//
//patch_19 Sdr1kUsb driver implementing AVR Si570 USB support
//patch_18 Workaround for random MOX problems (kf4bq)
//patch_17 Other changes required for patch_16
//patch_16 Support for DG8SAQ-I2C interface
//patch_15 Transmit Frequency value to Primary Keyer Serial port when tuned
//patch_14 Entering in VFOA sets softrock center frequency
//patch_13 SI570 Support
//patch_12 Disable IARU Out of Band TX blocking
//patch_11 PortAudio 4ch-1sndcard to 2ch-2sndcard mapping
//patch_10 Full duplex RX/TX
//patch_9 Default settings for SoftRock PowerSDR Release
//patch_8 At COM port RTS line is set high during MOX to switch SR T/R, DTR is set high to feed CTS, DSR inputs.
//patch_7 Dual Soundcard support
//patch_6 Added IQ sample correction in Soundcard audio settings
//patch_5 Baseband tuning during TX for SoftRock40 model (like RX; tune in soundcard baseband relative to centerfreq)
//patch_4 Disable LPT port, if LPT Address is set to 0
//patch_3 SoftRock40 model can be configured to enable TX capabilities
//patch_2 Product identification
//patch_1 History of changes in release_notes.cs
//
//		Coded By:		PE1NNZ
//		SVN Rev:		
//
